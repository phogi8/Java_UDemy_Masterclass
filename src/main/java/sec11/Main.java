...
public class Main {
    ...
    public static void main(String[] args) {
        Player one = new Player("Tim", 5, 5);
        System.out.println(one);
    }

    /*
    for the tree exercise
    old solution here but does not include SearchTree class
      https://www.udemy.com/course/java-the-complete-java-developer-course/learn/lecture/3805246#questions/12671194
    recommended yt video by Bro Code: Learn Binary search tree in 20 minutes
